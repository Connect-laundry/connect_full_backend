...
class OrderCreateSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        from laundries.services.laundry_validation import (
        ...
        if pricing_method == "PER_ITEM":
            ...
            for item_data in items_data:
                ...
                if not service_type_instance:
                    raise serializers.ValidationError(f"Service type is required for {
                            item_instance.name}")
                ...
                try:
                    ...
                    raise serializers.ValidationError(f"Laundry does not offer {
