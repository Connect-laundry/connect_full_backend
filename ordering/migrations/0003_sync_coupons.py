    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(
                default=1, help_text="Times a single user can use this coupon."
            ),
        ),
        migrations.AlterField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="coupons", to="laundries.laundry"
            ),
        ),
        migrations.AlterField(
            model_name="coupon",
            ...
            field=models.DecimalField(
                blank=True,
                decimal_places=2,
                help_text="Maximum discount allowed (for percentage type).",
                max_digits=10,
                null=True,
            ),
        ),
