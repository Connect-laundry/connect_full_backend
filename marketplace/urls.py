...
urlpatterns = [
    ...
    path('legal/', SupportLegalDocumentListView.as_view(), name='support_legal_list'),
    path('legal/<str:type>/', SupportLegalDocumentDetailView.as_view(), name='support_legal_detail'),
