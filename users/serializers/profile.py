...
from utils.media import OptionalMediaWriteMixin, SafeMediaModelSerializer
...
class ProfileSerializer(OptionalMediaWriteMixin, SafeMediaModelSerializer):
    ...
    class Meta:
        ...
        # Avatar is optional: a storage outage must not 500 a profile update.
