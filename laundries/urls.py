...
router.register(
    r'dashboard/orders',
    DashboardOrderViewSet,
    basename='dashboard-orders')
router.register(
    r'dashboard/my-laundry',
    OwnerLaundryViewSet,
    basename='owner-laundry')
router.register(
    r'dashboard/machines',
    MachineViewSet,
    basename='dashboard-machines')
