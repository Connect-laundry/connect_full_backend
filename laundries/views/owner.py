...
class OwnerLaundryViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return Laundry.objects.filter(owner=self.request.user).prefetch_related(
            "opening_hours"
        )
    ...
    def create(self, request, *args, **kwargs):
        ...
        logger.info(f"Laundry created by {
                request.user.email}: {
    ...
    def hours(self, request, pk=None):
        ...
        logger.info(f"Opening hours updated for laundry {
                laundry.id} by {
                request.user.email}")
    ...
    def reviews(self, request, pk=None):
        ...
        laundry = self.get_object()
        reviews = (
            Review.objects.filter(laundry=laundry)
            .select_related("user")
            .order_by("-created_at")
        )
        ...
        return Response(
            {"success": True, "message": "Reviews retrieved.", "data": serializer.data}
        )
